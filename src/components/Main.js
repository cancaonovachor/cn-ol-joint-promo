      ...
      >
        ...
        >
          ...
          <p>
            ...
            <br />
            <br />
            ①活動本拠地の撤廃…関東/関西/東海支部の3支部で活動。全国展開を計画中。遠隔コミュニケーションのための配信システムを構築。
            <br />
            ②合唱音楽の拡張…混声・男声・女声の枠組みにとらわれない選曲。指導者を置かない全員参加型のアンサンブル
            <br />
            ③コロナ禍での持続的な活動…オンライン作品制作、楽曲制作、グッズ制作、システム開発などの複数のチームを立ち上げ。団員の個性に合わせたティール的組織運営を実施。
            <br />
            <br />
        ...
        >
          ...
          <h3>下薗（CancaoNova）</h3>
          <p>
            本演奏会に興味を持ってくださった皆様、誠にありがとうございます。
          </p>
          <p>
