  ...
  return (
    ...
    >
      ...
      >
        ...
        <h3>Ligeti György - The Alphabet </h3>
        <p>
        ...
        <h3>Pierre Villette - O magnum mysterium </h3>
        <p>
        ...
        <p>
          中世の修道士 聖フランチェスコに関する４つの祈りのテキストにFrancis
          Poulencが作曲、シャンフリールの修道士たちによって初演された。中世聖歌の古風な要素がプーランクらしいハーモニーと融合した作品。
        </p>
        ...
        <h3>Francis Poulenc - Chanson à boire </h3>
        <p>
        ...
        <h3>Adrian Willaert - Vecchie letrose</h3>
        <p>
          盛期ルネサンス時代のフランドル出身の作曲家Adrian
          Willaertによるフラットラ。
          軽快で大衆的（そしてやや下品）な音楽は、フランスのシャンソンにも影響を与えた。
          対位的複雑さを避け、最上声部が主旋律として扱われており、現代に繋がる音楽のルーツが垣間見える。
        </p>
        <h3>Josquin des Prez - Ave Maria</h3>
        <p>
          盛期ルネサンス時代のフランス作曲家Josquin des
          Prezによって作曲された有名なモテット。
          旋律が各声部で模倣される通模倣様式により展開しながら、中間部ではデュエット的な構成も見られる。
          最後の行では全声部が揃って静かな祈りを捧げている。
        </p>
        <h3>Claude Debussy - Yver, vous n'estes qu'un Villain</h3>
        <p>
          冬に対する恨み、夏に対する愛情がユーモラスに表現されたテキストを用いた、印象派の作曲家Claude
          Debussyによる作品。
          冬のシーンはホ短調で噛み締めるようなスタッカートで表現され、夏のシーンでは平行長調で牧歌的に表現される。
        </p>
        <h3>Olivier Messiaen - O Sacrum Convivium!</h3>
        <p>
          フランスの現代作曲家Olivier Messiaenにより作曲された宗教作品。
          共感覚であった作曲家らしい色彩豊かなハーモニーとノンハーモニックに感じられるソプラノのメロディが、現実離れした音世界を作り出している。
        </p>
        <h3>三善晃 - 地球へのピクニック</h3>
        <p>
          組曲「地球へのバラード」の終曲。
          近代フランス音楽の色合いが感じられる三善晃の作品の中でも、
          谷川俊太郎の詩に作曲したこの曲は、色彩豊かなハーモニー展開、鋭いリズム、
          宇宙規模のテキストによって演奏会の締めくくりとしてふさわしい一曲となっている。
        </p>
